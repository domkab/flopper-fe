      ...
      <ul>
          ...
          <ul className="sub-menu">
            ...
            <li className="menu-item-has-children">
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/home-electronics-three"}>
                ...
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/home-organic-food-two"}>
            ...
            <li className="menu-item-has-children">
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/home-medical-equipment"}>
                ...
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/home-black-friday-two"}>
          ...
          <ul className="sub-menu">
            <li className="menu-item-has-children">
              ...
              <ul className="sub-menu">
                ...
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/shop-grid-filter"}>
                    {t("shop_grid_filter")}
                  </Link>
                </li>
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/shop-grid-two-column"}>
                    {t("shop_grid_two_column")}
                  </Link>
                </li>
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/shop-grid-no-sidebar"}>
                    {t("shop_grid_no_sidebar")}
                  </Link>
                </li>
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/shop-grid-full-width"}>
                    {t("shop_grid_full_width")}
                  </Link>
                </li>
                <li>
                  <Link
                    to={import.meta.env.VITE_PUBLIC_URL + "/shop-grid-right-sidebar"}
                  >
                    {t("shop_grid_right_sidebar")}
                  </Link>
                </li>
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/shop-list-standard"}>
                    {t("shop_list_standard")}
                  </Link>
                </li>
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/shop-list-full-width"}>
                    {t("shop_list_full_width")}
                  </Link>
                </li>
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/shop-list-two-column"}>
            ...
            <li className="menu-item-has-children">
              <Link to={import.meta.env.VITE_PUBLIC_URL + "/product/1"}>
                {t("product_details")}
              </Link>
              <ul className="sub-menu">
                <li>
                ...
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/product-tab-left/1"}>
                    {t("product_tab_left")}
                  </Link>
                </li>
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/product-tab-right/1"}>
                    {t("product_tab_right")}
                  </Link>
                </li>
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/product-sticky/1"}>
                    {t("product_sticky")}
                  </Link>
                </li>
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/product-slider/1"}>
                    {t("product_slider")}
                  </Link>
                </li>
                <li>
                  <Link to={import.meta.env.VITE_PUBLIC_URL + "/product-fixed-image/1"}>
        ...
        <li className="menu-item-has-children">
          ...
          <ul className="sub-menu">
            ...
            <li>
              <Link to={import.meta.env.VITE_PUBLIC_URL + "/blog-no-sidebar"}>
                {t("blog_no_sidebar")}
              </Link>
            </li>
            <li>
              <Link to={import.meta.env.VITE_PUBLIC_URL + "/blog-right-sidebar"}>
