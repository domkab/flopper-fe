            ...
            <ul className="mega-menu">
              ...
              <li>
                <ul>
                  ...
                  <li>
                    <Link
                      to={import.meta.env.VITE_PUBLIC_URL + "/product-fixed-image/1"}
                    >
                      {t("product_fixed_image")}
                    </Link>
                  </li>
                  <li>
                    <Link to={import.meta.env.VITE_PUBLIC_URL + "/product/8"}>
                      {t("product_simple")}
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to={import.meta.env.VITE_PUBLIC_URL + "/product/9"}>
                      {t("product_affiliate")}
                    </Link>
                  </li>
                </ul>
