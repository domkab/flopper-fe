...
const ProductModal: React.FC<ProductModalProps> = ({
  ...
  const [productStock, setProductStock] = useState(
    product.variation && product.variation.length > 0 && product.variation[0].size && product.variation[0].size.length > 0
                  ...
                  <div className="pro-details-color-wrap">
                    ...
                    <div className="pro-details-color-content">
                      {product.variation.map(singleVariation => {
                        return singleVariation.color === selectedProductColor ? (
                          singleVariation.size.map((singleSize, key) => (
                            <label key={key}>
                              <input
                                type="radio"
