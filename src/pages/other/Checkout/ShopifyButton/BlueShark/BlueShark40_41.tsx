...
const ShopifyBlueShark40_41: React.FC = () => {
      ...
      if ((window as any).ShopifyBuy) {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '8995304046926',
            variantId: '48413215293774',  // Ensure this is the correct variant ID for size 40-41
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719226910642" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyBlueShark40_41;
