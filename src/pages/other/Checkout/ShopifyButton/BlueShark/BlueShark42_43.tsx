...
const ShopifyBlueShark42_43: React.FC = () => {
      ...
      if ((window as any).ShopifyBuy) {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '8995304046926',
            variantId: '48413215261006',  // Ensure this is the correct variant ID for size 42-43
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719227264607" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyBlueShark42_43;
