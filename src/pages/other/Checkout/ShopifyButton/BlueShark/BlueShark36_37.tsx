...
// import './ShopifyBlueShark36_37.scss';

const ShopifyBlueShark36_37: React.FC = () => {
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719225189226" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyBlueShark36_37;
