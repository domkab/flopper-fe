...
const ShopifyPurpleShark44_45: React.FC = () => {
      ...
      if ((window as any).ShopifyBuy) {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '8995304046926',
            variantId: '48413214114126',  // Ensure this is the correct variant ID for size 44-45
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719331846361" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyPurpleShark44_45
