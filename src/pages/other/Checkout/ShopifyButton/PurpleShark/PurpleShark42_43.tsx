...
const ShopifyPurpleShark42_43: React.FC = () => {
      ...
      if ((window as any).ShopifyBuy) {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '8995304046926',
            variantId: '48413214146894',  // Ensure this is the correct variant ID for size 42-43
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719331693334" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyPurpleShark42_43
