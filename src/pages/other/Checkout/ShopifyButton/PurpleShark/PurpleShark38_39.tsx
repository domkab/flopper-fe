...
const ShopifyPurpleShark38_39: React.FC = () => {
      ...
      if ((window as any).ShopifyBuy) {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '8995304046926',
            variantId: '48413214212430',  // Ensure this is the correct variant ID for size 38-39
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719331151420" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyPurpleShark38_39
