...
const ShopifyPurpleShark36_37: React.FC = () => {
      ...
      if ((window as any).ShopifyBuy) {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '8995304046926',
            variantId: '48413214245198',  // Ensure this is the correct variant ID for size 36-37
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719330853425" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyPurpleShark36_37
