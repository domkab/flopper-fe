...
const ShopifyOrangeShark40_41: React.FC = () => {
      ...
      if ((window as any).ShopifyBuy) {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '8995304046926',
            variantId: '48413213983054',  // Ensure this is the correct variant ID for size 40-41
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719329847213" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyOrangeShark40_41;
