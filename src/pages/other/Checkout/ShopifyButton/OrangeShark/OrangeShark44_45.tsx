...
const ShopifyOrangeShark44_45: React.FC = () => {
      ...
      if ((window as any).ShopifyBuy) {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '8995304046926',
            variantId: '48413213917518',  // Ensure this is the correct variant ID for size 44-45
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719330436582" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyOrangeShark44_45
