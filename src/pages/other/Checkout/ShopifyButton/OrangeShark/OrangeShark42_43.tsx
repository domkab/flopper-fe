...
const ShopifyOrangeShark42_43: React.FC = () => {
      ...
      if ((window as any).ShopifyBuy) {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '8995304046926',
            variantId: '48413213950286',  // Ensure this is the correct variant ID for size 42-43
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719330165276" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyOrangeShark42_43
