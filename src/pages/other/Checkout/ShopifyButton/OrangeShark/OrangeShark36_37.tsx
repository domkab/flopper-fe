...
const ShopifyOrangeShark36_37: React.FC = () => {
      ...
      if ((window as any).ShopifyBuy) {
        ...
        (window as any).ShopifyBuy.UI.onReady(client).then((ui: any) => {
          ui.createComponent('product', {
            id: '8995304046926',
            variantId: '48413214048590',  // Ensure this is the correct variant ID for size 36-37
  ...
  return (
    <div className="pro-details-cart btn-hover">
      <div id="product-component-1719329154490" ref={shopifyRef}></div>
    </div>
  );
};

export default ShopifyOrangeShark36_37;
