                      ...
                      <table>
                        ...
                        <tbody>
                          {cartItems.map((cartItem: CartItem, key: number) => {
                            ...
                            const discountedPrice = getDiscountPrice(cartItem.price, cartItem.discount) || 0;
                            const finalProductPrice = (cartItem.price * currency.currencyRate).toFixed(2);
                            const finalDiscountedPrice = (discountedPrice * currency.currencyRate).toFixed(2);

                            const effectivePrice = discountedPrice !== 0 ? finalDiscountedPrice : finalProductPrice;
                            cartTotalPrice += Number(effectivePrice) * cartItem.quantity;
                            ...
                            return (
                              <tr key={key}>
                                ...
                                <td className="product-subtotal">
                                  {discountedPrice !== 0
                                    ? currency.currencySymbol +
                                    (Number(finalDiscountedPrice) * cartItem.quantity).toFixed(2)
                                    : currency.currencySymbol +
                                    (Number(finalProductPrice) * cartItem.quantity).toFixed(2)}
                                </td>
